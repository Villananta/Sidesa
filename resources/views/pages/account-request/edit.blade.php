                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="date_of_birth" id="date_of_birth" class="form-control @error ('date_of_birth') is-invalid @enderror" value="{{ old('date_of_birth', $resident->date_of_birth) }}">
                            @error('date_of_birth')
                                <span class="invalid-feedback d-block">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="place_of_birth" id="place_of_birth" class="form-control @error ('place_of_birth') is-invalid @enderror" value="{{ old('place_of_birth', $resident->place_of_birth) }}">
                        ...
                        <select name="religion" id="religion" class="form-control">
                            ...
                            <option value="katholik"{{ old('religion', $resident->religion) == 'katholik' ? 'selected' : '' }}>Khatolik</option>
                            <option value="hindu"{{ old('religion', $resident->religion) == 'hindu' ? 'selected' : '' }}>Hindu</option>
                            <option value="budha"{{ old('religion', $resident->religion) == 'budha' ? 'selected' : '' }}>Budha</option>
                            <option value="khonghucu"{{ old('religion', $resident->religion) == 'khonghucu' ? 'selected' : '' }}>khonghucu</option>
                        </select>
                        </div>
                        <div class="form-group mb-3">
                            ...
                            <select name="marital_status" id="marital_status" class="form-control">
                                ...
                                <option value="widower"{{ old('marital_status', $resident->marital_status) == 'widower' ? 'selected' : '' }}>Duda</option>
                                <option value="widow"{{ old('marital_status', $resident->marital_status) == 'widow' ? 'selected' : '' }}>Janda</option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="pindahan" {{ old('status', $resident->status) == 'pindahan' ? 'selected' : '' }}>Pindahan</option>
